...
async def auto_post(client, message):
    ...
    merge_key = re.sub(r"\s+"," ", f"{title.lower()} {show_year}").strip()

    print("==== DEBUG MERGE KEY ====")
    print(merge_key)
    print("========================")
    ...
    line = f"➤ {quality} {codec} {source} ➪ <a href='{link}'><b>Get File</b></a> ({size_text})"

    header = f"""<b>🔖 Title:</b> {title}
<b>🎬 Genres:</b> N/A
...
<b>💪 Powered By :</b> <a href="https://t.me/MzMoviiez"><b>MzMoviiez</b></a>
"""
