...
def clean_movie_title(raw):
    ...
    raw = re.sub(r"\b(hindi|telugu|tamil|malayalam|marathi|dual|audio|uncut|south|web|webdl|webrip|bluray|hdrip|brrip|x264|x265|hevc|dd|ddp|aac|kbps|mk|mkv|mp4)\b","", raw, flags=re.I)
...
async def auto_post(client,message):
    ...
    if not poster or not genres or not story:
        tposter,trating,tyear,tstory,tgenres = tmdb_fetch(title)
